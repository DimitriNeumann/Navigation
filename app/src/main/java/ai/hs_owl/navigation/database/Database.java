...
public class Database extends SQLiteOpenHelper {
    ...
    public static String KNOTEN_TABLE_CREATE = "create table IF NOT EXISTS " + KNOTEN_TABLE_NAME + " (" + KNOTEN_COLUMN_ID + " text not null, " + KNOTEN_COLUMN_X + " REAL not null, " + KNOTEN_COLUMN_Y + " REAL not null," + KNOTEN_COLUMN_EBENE + " integer not null)";
    //Verbindungen
    ...
    public static String VERBINDUNGEN_TABLE_CREATE = "create table IF NOT EXISTS " + VERBINDUNGEN_TABLE_NAME + " (" + VERBINDUNGEN_COLUMN_IDA + " text not null, " + VERBINDUNGEN_COLUMN_IDB + " REAL not null, " + VERBINDUNGEN_COLUMN_GEWICHT + " REAL not null," + VERBINDUNGEN_COLUMN_OUTDOOR + " integer not null)";
