 ...
 * 
 * Because Java has no simple console input, I added this functions to my
 * library. Simply import
 * <code>import static eu.gressly.io.utility.Input.*</code> and then use
...
public class Input {
	...
	/**
	 * If askAgain is false, the user is asked only once. Entering newlines do
	 * not ask the user again showing the "question". default: true
	 * 
	 * @param askAgain
	 */
	 ...
	 * "question", this text has to be set. Typically: setAddQuestion(
	 * "Please enter the value for %s : "); "%s" is replaced by the programmers
	 * question afterwards.
	 * 
	 * @param addQuestion
	 *            has to contain a %s, where the parameter name sohuld be
	 *            replaced.
	 */
	...
	/**
	 * This message is shown to the user, if she/he does not enter a number
	 * while using "intputInt()" or "inputDouble()".
	 * 
	 * @param errorMessage
	 *            to show on NumberFormatExceptions.
	 */
	...
	/**
	 * Input a single char. Any further chars on the same line are ignored.
	 */
	 ...
	 * 
	 * @param question
	 *            any Question having "yes" or "no" as answer.
